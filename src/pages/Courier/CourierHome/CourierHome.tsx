    ...
    <IonPage className="overflow-hidden">
      <IonContent fullscreen scrollY={false} className="bg-[#F3F5F7] font-sans">
        <div className="h-full w-full relative">
          <div ref={mapContainer} className="absolute inset-0" style={{ height: 'calc(100% + 40px)' }} />
          <div className="absolute bottom-0 left-0 right-0 pb-64 px-4 bg-transparent" style={{ height: '150px' }}>
            <button className="w-full bg-[#7862FC] text-white font-semibold py-3 rounded-xl mb-4">
              Start Delivery
            </button>
